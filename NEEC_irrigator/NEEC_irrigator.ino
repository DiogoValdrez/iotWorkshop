...
#define AP_SSID     "TP-LINK_43CC"
#define AP_PASSWORD "80087816"


// Antes de se definir a password e o username é preciso criar conta em:
// https://easyiot-cloud.com
#define EIOTCLOUD_USERNAME "Duz2002"
#define EIOTCLOUD_PASSWORD "azores"
...
#define PIN_PUMP         D0 //LED_BUILTIN - LED do nodeMCU OU D0 - se a bomba estiver conectada ao pin D0
...
void setup() {
  ...
  Serial.begin(9600); //Inicia a comunicação com uma largura de banda de 115200 bps (baud rate)
  ...
  if (storage.moduleId == 0)
  {
    ...
    myMqtt.SetParameterDescription(storage.moduleId, PARAM_HUMIDITY, "Humidade do solo: ");
...
#endif
    for(int t=i; t < sizeof(storage);t++)
